import { parseDuration, makedurationbigger, client, ownerId, logerror, groupId, getUserRankIndex, retry, noblox } from "../index";
...
export const data = new SlashCommandBuilder()
    ...
    .addStringOption(option => option.setName(`rank`)
