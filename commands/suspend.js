import { parseDuration, makedurationbigger, client, ownerId, logerror, groupId, getUserRankIndex, retry, noblox, rankData, chnlsend } from "../index.js";
...
export const data = new SlashCommandBuilder()
    ...
    .addStringOption(option => option.setName(`proof`)
